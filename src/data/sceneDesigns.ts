...
export const SCENE_DESIGNS: Record<string, SceneDesign> = {
  rose: {
    overview: "场景范围为 60m×60m 的开放公园。中央蜿蜒的花瓣形主步道（宽度3m），由发光花瓣纹理铺成，从入口延伸到中央喷泉。步道两侧错落分布20丛玫瑰花（每丛5-12朵，高度0.5m-2m不等）。场景入口处矗立4m高、6m宽的大型玫瑰拱门，藤蔓缠绕，花朵密集垂挂。右侧中央为直径8m的圆形星辰喷泉，拥有三层水流。5张星辰长椅散落分布在步道旁的树荫下。远景是巨大的玫瑰色星云，螺旋纹理缓慢流动，远处花田延伸到天际。",
    layers: [
      "远景层：巨大的玫瑰色星云，缓慢流动的螺旋纹理，远处延伸到天际的花田，带景深虚化。",
      "中远景层：高耸的开花乔木，树冠蓬松，外围低矮灌木丛。",
      "中景层：4m高的大型玫瑰拱门，直径8m的中央星辰喷泉，蜿蜒的发光花瓣主步道。",
      "近景层：步道旁高低错落的玫瑰花丛，带有木纹细节的星辰长椅，地面的发光草地与小野花。",
      "粒子层：全屏漂浮的粉色星辰粒子，喷泉溅起的半透明水花粒子，缓慢飘落的花瓣特效。"
    ],
    modeling: [
      ...
      { title: "星辰喷泉", desc: ["三层磨砂星辰石底座，带有精细雕花", "半透明粉色发光水流，循环向上喷涌再落下", "池壁雕刻花纹，水面波纹反射，水花化为星辰飘散"] },
      { title: "花瓣步道", desc: ["嵌入花瓣形发光地砖，独立纹理，深浅排列自然", "步道边缘淡粉色发光线缓慢呼吸闪烁", "星辰草地材质，踩踏留有微弱光痕"] }
    ],
    dynamics: [
    ...
    interactions: [
      { element: "玫瑰花丛", trigger: "所有花朵同时完全绽放，散发出15-20颗爱心形状星辰粒子，花瓣飘落加速，持续3秒后慢慢闭合", function: "纯视觉治愈交互；累计点击10次解锁「花匠」成就" },
      { element: "星辰喷泉", trigger: "喷泉高度翻倍，溅出范围扩大，散发大量彩色星辰，周围星宠向喷泉聚集", function: "触发星宠聚集事件，增加社交互动概率" },
      { element: "玫瑰拱门", trigger: "拱门发出明亮粉光，落下持续5秒的花瓣雨，全场景花瓣密度翻倍", function: "打卡功能，生成当前场景的宠物合影" },
      { element: "星辰长椅", trigger: "长椅发出微光，附近星宠跳上长椅趴下休息，尾巴轻轻摆动", function: "触发宠物休息动作，生成耳语事件素材" },
      { element: "步道地面", trigger: "点击位置生成一朵临时小玫瑰，从地面长出，3秒后消散为星辰", function: "纯趣味微交互" }
    ],
    petBehaviors: [
      { location: "花丛旁", action: "星宠主动靠近，低头闻花香，鼻子抽动", duration: "5-8秒", effect: "头顶冒出粉色爱心星辰" },
  ...
  vega: {
    overview: "场景范围为50m×50m的山坡小镇。中央星辰石板路从山脚延伸至山顶广场，路面带有坡度。山坡错落分布8栋圆顶星辰小屋，窗户透出暖黄色灯光。左侧山顶耸立3层高的星辰灯塔，塔顶旋转光束缓慢扫过全景。右侧山脚为「星辰面包店」，挂有铃铛招牌及发光橱窗。山顶中央的小镇广场摆放2张木质方桌与4把椅子。周围点缀12棵发光像素树（树叶蓝紫，树干深紫）。远景为深紫色夜空，布满闪烁星星及连绵的暖紫色渐变星辰山丘。",
    layers: [
      "远景层：深紫色夜空，闪烁星星，暖紫色连绵的星辰山丘轮廓，带景深虚化。",
      "中远景层：错落分布的深紫色发光树木，山坡后方的地形起伏。",
      "中景层：8栋圆顶星辰小屋，3层高星辰灯塔，星辰面包店，山顶中央小镇广场。",
      "近景层：带有磨损痕迹的发光石板路，路灯，木质桌椅及台灯，低矮草丛与石头。",
      "粒子层：小镇上空缓慢漂浮的微小星辰粒子，小屋烟囱冒出的星辰烟雾。"
    ],
    modeling: [
      { title: "星辰小屋", desc: ["半透明深蓝色星辰质感墙壁，可隐约看见内部轮廓", "紫色瓦片屋顶带有苔藓，暖黄色发光方窗带有木框细节", "木质门带把手与小台阶，屋顶烟囱持续冒出星辰烟雾"] },
      { title: "星辰灯塔", desc: ["3层石质纹理圆柱塔身，带有砖块拼接与风化痕迹", "顶部玻璃金属灯室，内置旋转光源射出暖黄色体积光束（30秒/圈）"] },
    ...
    interactions: [
      { element: "面包店招牌", trigger: "铃铛晃动发声，门口冒出热气星辰，橱窗面包变亮，弹出菜单", function: "零食购买入口，消耗星辰币恢复对话次数" },
      { element: "灯塔塔顶", trigger: "光束旋转翻倍，亮度提升，全景被暖光照亮2秒", function: "场景氛围交互，打卡合影" },
      { element: "小屋窗户", trigger: "灯光闪烁3次，窗帘拉开见模糊星辰影子走动，2秒后拉上", function: "纯趣味微交互" },
  ...
  comet: {
    overview: "场景范围为直径80m的环形跑道。主体环形发光跑道宽8m，表面呈现彗星尾迹质感（深蓝至亮白渐变），附带极速流动光效。起点处悬浮着立体的「3、2、1」数字倒计时牌和发光起跑线。跑道沿途均匀设立4个巨大的发光加速环。周边悬浮20颗表面坑洼、缓慢自转的深灰色小行星/陨石。内侧为草坪状星辰地面，点缀发光石块。远景是深邃宇宙，布满快速向后流动的速度线粒子，天空中可见缓慢旋转的星云漩涡与每隔10秒划过的流星。",
    layers: [
      "远景层：深邃宇宙背景，缓慢旋转的星云漩涡，快速划过的流星，向后流动的速度线。",
      "中远景层：悬浮在跑道周围的20颗坑洼陨石与小行星，高低远近错落。",
      "中景层：8m宽的环形发光跑道，悬浮数字倒计时牌，4个多层结构的巨大发光加速环。",
      "近景层：跑道内侧的发光草坪，点缀的星辰石块和低矮植物，跑道边缘呼吸闪烁的光带。",
      "粒子层：全屏飞速向后流动的速度线粒子，跑道表面的流动流光。"
    ],
    modeling: [
      { title: "彗星跑道", desc: ["半透明发光材质，中心亮白边缘深蓝，附带明显的流线型速度纹理", "跑道边缘蓝白光带持续呼吸闪烁，表面有凝固星辰的颗粒感，带微弱起伏"] },
    ...
    interactions: [
      { element: "起跑线", trigger: "触发 3-2-1-GO 倒计时，所有星宠开始竞速，速度线密度翻倍", function: "赛跑小游戏，第一名获50星辰币" },
      { element: "加速环", trigger: "加速环爆闪强光，下一只穿过的宠物速度翻倍且拖尾变长", function: "竞速辅助道具交互" },
      { element: "流星", trigger: "流星转向砸向跑道，爆炸成大片彩色星辰粒子", function: "纯视觉特效交互" },
      { element: "小行星", trigger: "轻微晃动，表面散发星辰粒子（模拟撞击）", function: "趣味互动" },
      { element: "跑道地面", trigger: "生成临时发光箭头加速道具，宠物踩踏后提速2秒", function: "微观干预辅助交互" }
    ],
    petBehaviors: [
      { location: "跑道主体", action: "沿跑道奔跑互相追逐，超过时触发蓝色光带，身后带星辰拖尾", duration: "持续", effect: "加速光带与拖尾特效" },
  ...
  library: {
    overview: "场景范围为40m×40m的圆形图书馆内部。四周被8层高的深棕色木质螺旋书架包围，书架直达星空穹顶，每层摆满独立建模的发光书籍。中央为直径15m的悬空圆形阅读平台，通过发光的螺旋悬浮楼梯相连。平台中央放置着大型星辰书桌（长3m），桌上配有翻开的星辰大书、羽毛笔、墨水瓶和摇曳的烛台，旁边是深紫色的布艺高背椅。约30只米粒大小的“书虫”（发光小生物）在书架间慢悠悠飞舞。顶部是缓慢旋转的螺旋状银河，底部弥漫着厚重的半透明星辰雾气。",
    layers: [
      "远景层：穹顶流动的螺旋状银河，密集星星缓慢闪烁。",
      "中远景层：螺旋上升直达穹顶的8层巨型木质书架，上半部分带强烈景深虚化。",
      "中景层：直径15m的悬空半透明阅读平台，发光的螺旋悬浮楼梯。",
      "近景层：中央星辰大书桌，高背椅，桌上细节（羽毛笔、墨水瓶、发光书籍、烛台）。",
      "粒子层：底部浓郁的半透明星辰雾气，在空中飞舞的30只发光书虫小生物。"
    ],
    modeling: [
      { title: "多层螺旋书架", desc: ["深棕色高精度木纹，每层带有古典雕花细节，螺旋上升", "数以千计独立建模的书籍，书脊带模糊星辰文字与各色微光，部分倾斜放置"] },
      { title: "中央大书桌与文具", desc: ["带有使用痕迹与磨损的深棕色木桌，桌角雕花", "桌面大书缓慢翻页（星辰文字纹理），羽毛笔细节逼真，烛台火焰带体积光"] },
      { title: "悬浮楼梯与平台", desc: ["台阶为发光石质，独立悬浮且螺旋上升，带有呼吸闪烁", "阅读平台半透明星辰质感，底部带有悬浮光效浮动，边缘设发光栏杆"] },
  ...
  gemini: {
    overview: "场景范围为60m×40m的新月形沙滩。前景是闪闪发光的金色星辰沙粒，具有自然的沙丘起伏与脚印纹理。前方是一片紫色的星海，海浪循环拍岸，浪花呈现白色星辰质感。海面上漂浮着两座大小、形状完全对称的双子小岛，岛上各有一棵对称弯曲的棕榈树。沙滩上散落着15个不同造型、散发微光的星辰贝壳。左侧设有蓝白条纹遮阳伞和浅棕色布艺躺椅，右侧建有一座带露台的沙滩小木屋。天空中悬挂着两个对称的双子太阳，散发橙紫柔光，海面偶尔有半透明星辰海豚跃出。",
    layers: [
      "远景层：粉紫色渐变天空，两颗对称的双子太阳，海天交界处的景深虚化。",
      "中远景层：两座完全对称的双子小岛（带草地、白色沙滩与棕榈树），跃出的星辰海豚。",
      "中景层：带有横向波纹与涨落动画的紫色星海，白色星辰浪花边缘。",
      "近景层：金色星辰沙滩，遮阳伞与躺椅，带露台的小木屋，散落的发光星辰贝壳。",
      "粒子层：海浪拍岸溅起的星辰水花，全屏缓慢漂浮的金色微小星辰粒子。"
    ],
    modeling: [
      { title: "金色沙滩与星海", desc: ["沙粒为细碎金色高光像素点，带有沙丘起伏、脚印及海浪冲刷的湿润反光痕迹", "海水从深紫到浅紫渐变，表面具备真实的波纹反射（倒映太阳与天空），白色星辰浪花包含细腻泡沫线"] },
      { title: "双子小岛", desc: ["绝对对称的两座微型岛屿，覆盖细腻草地", "棕榈树干弯曲角度对称，树叶随风摆动方向相反，边缘环绕礁石与浪花"] },
      { title: "星辰贝壳", desc: ["螺旋、扇形、海螺等多种高精模型，表面附带细腻珠光纹理", "开合动画展示内部的自发光高光珍珠，带有柔和光晕"] },
    ...
    interactions: [
      { element: "海水区域", trigger: "溅起星辰水花，生成涟漪向外扩散，浪花变大", function: "纯视觉互动体验" },
    ...
    petBehaviors: [
      ...
      { location: "沙滩上", action: "用爪子刨沙子，刨出小坑", duration: "5秒", effect: "沙粒星辰飞溅" },
  ...
  andromeda: {
    overview: "场景范围为50m×50m的圆形广场，是宏大且浪漫的核心社交区。中央矗立总高12m的四层大型星雕喷泉，各层水流颜色（深蓝、紫、粉紫、粉白）向上递进且越发纤细。底层水池直径20m，水面平静倒映着喷泉，漂浮12朵缓慢开合的星辰莲花。广场地面由发光石砖铺设出放射状的马赛克星座图案。广场边缘环绕12根古典多立克石柱，柱身缠绕发光藤蔓，柱顶燃烧永不熄灭的星辰火焰。远景是极其巨大且清晰的仙女座螺旋星云，星星密度极高，带来强烈的视觉震撼。",
    layers: [
      "远景层：巨大的仙女座螺旋星云，清晰的旋臂结构，极高密度的璀璨星空背景。",
      "中远景层：广场外围的阶梯与高层平台轮廓。",
      "中景层：12根带有藤蔓和火焰的古典石柱，直径20m的底层大水池。",
      "近景层：12m高的四层星辰喷泉主体，发光放射状石砖广场地面，漂浮的星辰莲花。",
      "粒子层：全场景极高密度的漂浮星辰（密度提升50%），喷泉四层溅射的巨量彩色水花粒子。"
    ],
    modeling: [
      { title: "四层大型喷泉", desc: ["极高精度的石雕主体，各层带有繁复雕花，顶端设有一颗高亮星珠", "水流为半透明发光星辰质感，带体积光与真实流体动力学喷射动画（每层颜色递变）"] },
      { title: "星辰莲花与水池", desc: ["莲花多层花瓣渐变，中心含金色发光花蕊，独立5秒循环开合动画", "池壁带雕纹，水面物理反射倒影清晰，微风波纹渲染逼真"] },
      { title: "古典石柱", desc: ["多立克柱式，深灰石质带有风化凹槽，柱头柱基精雕", "藤蔓发光叶片紧贴柱身，顶端暖黄色星辰火焰带摇曳动画与光晕"] },
    ...
    interactions: [
      { element: "喷泉中心", trigger: "喷射高度翻倍，散发巨量彩色星辰，全景星辰密度翻倍，持续5秒", function: "核心奇观展现，强制触发全场景宠物向广场聚集" },
      { element: "星辰莲花", trigger: "莲花完全绽放，中心升起发光许愿星，弹出许愿界面", function: "「许愿」功能入口，生成对应的系统记录" },
      ...
      { element: "广场地面", trigger: "亮起星辰光环沿马赛克纹理向外扩散，2秒后消散", function: "地表光带氛围交互" }
    ],
    petBehaviors: [
  ...
  orion: {
    overview: "场景范围为60m×60m的深邃发光森林。场景内树木高大挺拔，包含针叶与阔叶树种，树干深紫，树冠呈现蓝绿色的生物发光。地面覆盖着散发绿蓝色微光的苔藓与草丛。一条蜿蜒的「蘑菇小径」贯穿森林，由各色伞状发光蘑菇组成。几棵参天大树间悬挂着深绿色的星辰藤蔓，垂坠着金黄色发光果实。森林深处大树根部有一个透出神秘蓝光的半圆形树洞。林间弥漫着厚重的底部星辰雾气，约50只忽明忽暗的黄色萤火虫在空中游荡。透过树冠缝隙，可清晰仰望夜空中标志性的猎户座腰带三星。",
    layers: [
    ...
    interactions: [
      ...
      { element: "发光果实", trigger: "果实脱落砸向地面，摔碎迸发出大量金色星辰粒子", function: "环境彩蛋" },
